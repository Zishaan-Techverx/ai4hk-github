...
namespace TpaSodManagement.Services.Implementations
{
    public class OrganizationService : IOrganizationService
    {
        ...
        /// <summary>
        /// Queries the database for any existing organization (non-deleted) with the same name.
        /// Used for Create/Edit validation so duplicate organization names are rejected.
        /// </summary>
